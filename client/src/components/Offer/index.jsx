    ...
    <section className="offer_section">
        <div className="offer_top">
           <div className="offer_top_box">
            <h1>4k+</h1>
            <h3> <span> Successfully</span> Trained</h3>
           </div>


           <div className="offer_top_box">
            <h1>10k+</h1>
            <h3> <span> Classes </span> Completed</h3>
           </div>


           <div className="offer_top_box">
            <h1>90% +</h1>
            <h3> <span> Satisfaction </span>Rate</h3>
           </div>


           <div className="offer_top_box">
            <h1>53k+</h1>
            <h3> <span> Students </span> Community</h3>
           </div>
        </div>
      ...
      <div className="offer_container">
        ...
        <div className="offer_container_text">
          ...
          <h2>25% Offer First  <span>10 Student’s </span>  For Featured</h2>
